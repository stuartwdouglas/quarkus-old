...
public final class BuildExecutionBuilder {
   ...
   * @return this builder
   * @throws IllegalArgumentException if this deployer chain was not declared to initially produce
   *     {@code type}, or if the item does not allow multiplicity but this method is called more
   *     than one time
   */
   ...
   * @return this builder
   * @throws IllegalArgumentException if this deployer chain was not declared to initially produce
   *     {@code type}, or if {@code type} is {@code null}, or if the item does not allow
   *     multiplicity but this method is called more than one time
   */
   ...
   *     multiplicity but this method is called more than one time
   */
  public <N, T extends NamedBuildItem<N>> BuildExecutionBuilder produce(
      Class<T> type, N name, T item) {
    Assert.checkNotNullParam("type", type);
    Assert.checkNotNullParam("name", name);
    Assert.checkNotNullParam("item", item);
