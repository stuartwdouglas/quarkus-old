...
public final class BuildResult {
  ...
  BuildResult(
      final ConcurrentHashMap<ItemId, BuildItem> simpleItems,
      final ConcurrentHashMap<ItemId, List<BuildItem>> multiItems,
      final Set<ItemId> finalIds,
  ...
  /**
   * Get the amount of elapsed time from the time the operation was initiated to the time it was
   * completed.
   *
