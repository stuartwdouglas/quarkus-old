...
public final class ChainBuildException extends Exception {
  ...
  /**
   * Constructs a new {@code DeployerChainBuildException} instance. The message is left blank
   * ({@code null}), and no cause is specified.
   */
  public ChainBuildException() {}

  /**
   * Constructs a new {@code DeployerChainBuildException} instance with an initial message. No cause
   * is specified.
   *
  ...
  /**
   * Constructs a new {@code DeployerChainBuildException} instance with an initial cause. If a
   * non-{@code null} cause is specified, its message is used to initialize the message of this
  ...
  /**
   * Constructs a new {@code DeployerChainBuildException} instance with an initial message and
   * cause.
   *
   * @param msg the message
   * @param cause the cause
