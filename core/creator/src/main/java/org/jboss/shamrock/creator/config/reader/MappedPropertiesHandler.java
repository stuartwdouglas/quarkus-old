...
public abstract class MappedPropertiesHandler<T> implements PropertiesHandler<T> {
  ...
  static class NestedHandlerWithSetter<P, C> implements PropertiesHandler<C> {
    ...
    public NestedHandlerWithSetter(
        PropertiesHandler<C> delegate, NestedSetter<P, C> nestedSetter, RootSetter<C> rootSetter) {
    ...
    @Override
    public void setNestedOnObject(Object o, String name, Object child)
        throws PropertiesConfigReaderException {
  ...
  public <C> MappedPropertiesHandler<T> map(
      String name, PropertiesHandler<C> nestedHandler, NestedSetter<T, C> setter) {
    return map(name, new NestedHandlerWithSetter<T, C>(nestedHandler, setter, null));
  }

  public <C> MappedPropertiesHandler<T> map(
      String name, PropertiesHandler<C> nestedHandler, RootSetter<C> setter) {
