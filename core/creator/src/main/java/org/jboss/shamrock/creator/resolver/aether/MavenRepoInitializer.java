...
public class MavenRepoInitializer {
  ...
  public static final File DEFAULT_GLOBAL_SETTINGS_FILE =
      new File(
          PropertyUtils.getProperty(MAVEN_HOME, envM2Home != null ? envM2Home : ""),
          "conf/settings.xml");
  ...
  public static DefaultRepositorySystemSession newSession(
      RepositorySystem system, Settings settings) {
    ...
    if (proxy != null) {
      ...
      final Proxy aetherProxy =
          new Proxy(proxy.getProtocol(), proxy.getHost(), proxy.getPort(), auth);
  ...
  public static List<RemoteRepository> getRemoteRepos(Settings settings)
      throws AppCreatorException {
  ...
  public static Settings getSettings() throws AppCreatorException {
    ...
    try {
      final SettingsBuildingResult result =
          new DefaultSettingsBuilderFactory().newInstance().build(settingsBuildingRequest);
          ...
          switch (problem.getSeverity()) {
            ...
            case FATAL:
              throw new AppCreatorException(
                  "Settings problem encountered at " + problem.getLocation(),
