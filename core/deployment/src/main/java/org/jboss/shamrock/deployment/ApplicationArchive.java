 ...
 *
 * <p>An application archive is an archive that provides components to the application. As a result
 * it will be indexed via jandex, and any deployment descriptors will be made available to the
 * application.
 */
public interface ApplicationArchive extends Closeable {
  ...
  /**
   * Returns a path representing the archive root. Note that if this is a jar archive this is not
   * the path to the jar, but rather a path to the root of the mounted {@link
