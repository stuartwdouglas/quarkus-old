...
public final class SubstrateConfigBuildItem extends MultiBuildItem {
  ...
  public SubstrateConfigBuildItem(Builder builder) {
    ...
    this.runtimeReinitializedClasses =
        Collections.unmodifiableSet(builder.runtimeReinitializedClasses);
    ...
    this.nativeImageSystemProperties =
        Collections.unmodifiableMap(builder.nativeImageSystemProperties);
  }
