...
/**
 * A build item that represents a {@link java.lang.reflect.Proxy} definition that will be required
 * on substrate. This definition takes the form of an ordered list of interfaces that this proxy
 * will implement.
 */
