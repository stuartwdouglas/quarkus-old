...
public final class LoggingResourceProcessor {
  ...
  @Inject BuildProducer<SubstrateSystemPropertyBuildItem> systemProp;

  @Inject BuildProducer<RuntimeInitializedClassBuildItem> runtimeInit;

  @Inject BuildProducer<GeneratedResourceBuildItem> generatedResource;
  ...
  public void build() throws Exception {
    ...
    try (ClassCreator cc =
        new ClassCreator(
            new ProcessorClassOutput(generatedClass),
            GENERATED_CONFIGURATOR,
            null,
            "java/lang/Object",
      ...
      if (consoleColor) {
        runtimeInit.produce(
            new RuntimeInitializedClassBuildItem(
                "org.jboss.logmanager.formatters.TrueColorHolder"));
      }
      ...
      final BytecodeCreator ifRootLogger =
          ifRootLogger(
              handlersOf,
              b ->
                  b.readStaticField(
      ...
      BranchResult buildOrRunBranchResult =
          ifRootLogger.ifNonZero(
              ifRootLogger.invokeStaticMethod(
                  MethodDescriptor.ofMethod(
                      ImageInfo.class, "inImageBuildtimeCode", boolean.class)));
      ...
      if (consoleEnable) {
        ...
        if (consoleColor) {
          ...
          final ResultHandle consoleProbeResult =
              branch.invokeStaticMethod(
                  MethodDescriptor.ofMethod(System.class, "console", Console.class));
        ...
        console =
            branch.newInstance(
                MethodDescriptor.ofConstructor(ConsoleHandler.class, Formatter.class), formatter);
        ...
        consoleErrorManager =
            branch.invokeVirtualMethod(
                MethodDescriptor.ofMethod(
                    ConsoleHandler.class, "getLocalErrorManager", ErrorManager.class),
                console);
        branch.invokeVirtualMethod(
            MethodDescriptor.ofMethod(ConsoleHandler.class, "setLevel", void.class, Level.class),
            console,
      ...
      if (fileEnable) {
        ...
        file =
            branch.newInstance(
                MethodDescriptor.ofConstructor(FileHandler.class, Formatter.class), formatter);
        branch.invokeVirtualMethod(
        ...
        branch.invokeVirtualMethod(
            ...
            file,
            branch.newInstance(
                MethodDescriptor.ofConstructor(File.class, String.class), branch.load(filePath)));
        if (consoleErrorManager != null) {
          branch.invokeVirtualMethod(
              MethodDescriptor.ofMethod(
                  FileHandler.class, "setErrorManager", void.class, ErrorManager.class),
              file,
              consoleErrorManager);
        }
      } else {
      ...
      if (consoleEnable && fileEnable) {
        ...
        array =
            branch.readStaticField(
                FieldDescriptor.of(EmbeddedConfigurator.class, "NO_HANDLERS", Handler[].class));
      }
      ...
      BytecodeCreator minLevelOfBc =
          ifNotRootLogger(minimumLevelOf, b -> getLevelFor(b, rootMinLevel));
      ...
      for (Map.Entry<String, CategoryConfig> category : categories.entrySet()) {
        ...
        levelOfBc =
            ifNotLogger(
                levelOfBc, category.getKey(), b -> getLevelFor(b, category.getValue().level));
        minLevelOfBc =
            ifNotLogger(
                minLevelOfBc, category.getKey(), b -> getLevelFor(b, category.getValue().minLevel));
      }
    ...
    systemProp.produce(
        new SubstrateSystemPropertyBuildItem(
            "java.util.logging.manager", "org.jboss.logmanager.LogManager"));
  }

  private BytecodeCreator ifRootLogger(
      BytecodeCreator orig, Function<BytecodeCreator, ResultHandle> returnIfNotRoot) {
  ...
  private BytecodeCreator ifNotRootLogger(
      BytecodeCreator orig, Function<BytecodeCreator, ResultHandle> returnIfRoot) {
    BranchResult branchResult =
        orig.ifNonZero(
            orig.invokeVirtualMethod(
                MethodDescriptor.ofMethod(String.class, "isEmpty", boolean.class),
  ...
  private BytecodeCreator ifNotLogger(
      BytecodeCreator orig,
      String category,
      Function<BytecodeCreator, ResultHandle> returnIfCategory) {
    BranchResult branchResult =
        orig.ifNonZero(
            orig.invokeVirtualMethod(
  ...
  private ResultHandle getLevelFor(final BytecodeCreator bc, final String levelName) {
    switch (levelName) {
      ...
      case "DEBUG":
      case "TRACE":
        return bc.readStaticField(
            FieldDescriptor.of(
                org.jboss.logmanager.Level.class, levelName, org.jboss.logmanager.Level.class));
      case "OFF":
      case "SEVERE":
      case "WARNING":
        // case "INFO":
