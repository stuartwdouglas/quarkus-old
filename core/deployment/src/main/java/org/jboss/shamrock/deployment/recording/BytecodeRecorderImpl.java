...
/**
 * A class that can be used to record invocations to bytecode so they can be replayed later. This is
 * done through the use of class templates and recording proxies.
 *
 * <p>A class template is simple a stateless class with a no arg constructor. This template will
 * contain the runtime logic used to bootstrap the various frameworks.
 *
 * <p>A recording proxy is a proxy of a template that records all invocations on the template, and
 * then writes out a sequence of java bytecode that performs the same invocations.
 *
 * <p>There are some limitations on what can be recorded. Only the following objects are allowed as
 * parameters to recording proxies:
 *
 * <p>- primitives - String - Class (see {@link #classProxy(String)} to handle classes that are not
 * loadable at generation time) - Objects with a no-arg constructor and getter/setters for all
 * properties - Any arbitrary object via the {@link #registerSubstitution(Class, Class, Class)}
...
public class BytecodeRecorderImpl implements RecorderContext {
  ...
  private static final MethodDescriptor COLLECTION_ADD =
      ofMethod(Collection.class, "add", boolean.class, Object.class);
  private static final MethodDescriptor MAP_PUT =
  ...
  @Override
  public <F, T> void registerSubstitution(
      Class<F> from, Class<T> to, Class<? extends ObjectSubstitution<F, T>> substitution) {
    substitutions.put(from, new SubstitutionHolder(from, to, substitution));
  }

  @Override
  public <T> void registerNonDefaultConstructor(
      Constructor<T> constructor, Function<T, List<Object>> parameters) {
    nonDefaultConstructors.put(
  ...
  private class MethodRecorder {
    ...
    public <T> T getRecordingProxy(Class<T> theClass) {
      ...
      ProxyFactory<T> factory =
          new ProxyFactory<T>(
              new ProxyConfiguration<T>()
                  .setSuperClass(theClass)
                  .setClassLoader(classLoader)
                  .setProxyName(
                      getClass().getName() + "$$RecordingProxyProxy" + COUNT.incrementAndGet()));
      try {
        T recordingProxy =
            factory.newInstance(
                new InvocationHandler() {
                  ...
                  public Object invoke(Object proxy, Method method, Object[] args)
                      throws Throwable {
                    StoredMethodCall storedMethodCall =
                        new StoredMethodCall(theClass, method, args);
    ...
    private ProxyInstance getProxyInstance(Class<?> returnType)
  ...
  public void writeBytecode(ClassOutput classOutput) {
    ClassCreator file =
        ClassCreator.builder()
            .classOutput(ClassOutput.gizmoAdaptor(classOutput, true))
            .className(className)
            .superClass(Object.class)
            .interfaces(StartupTask.class)
            .build();
    ...
    for (BytecodeInstruction set : methodRecorder.storedMethodCalls) {
      if (set instanceof StoredMethodCall) {
        ...
        ResultHandle callResult =
            method.invokeVirtualMethod(
                ofMethod(
                    call.method.getDeclaringClass(),
                    call.method.getName(),
                    call.method.getReturnType(),
                    call.method.getParameterTypes()),
                classInstanceVariables.get(call.theClass),
                params);
  ...
  private ResultHandle loadObjectInstance(
      MethodCreator method,
      Object param,
      Map<Object, ResultHandle> returnValueResults,
      Class<?> expectedType) {
    ...
    if (param == null) {
      ...
      try {
        ...
        out =
            method.invokeInterfaceMethod(
                ofMethod(ObjectSubstitution.class, "deserialize", Object.class, Object.class),
                subInstane,
                serialized);
      } catch (Exception e) {
      ...
      if (val.isPresent()) {
        ...
        return method.invokeStaticMethod(
            ofMethod(Optional.class, "of", Optional.class, Object.class), res);
      } else {
      ...
      // if a string is passed into the template that was obtained from config the config key used
      // to obtain it is recorded
      ...
      if (configParam != null) {
        out =
            method.invokeStaticMethod(
                ofMethod(ConfigHelper.class, "getString", String.class, String.class, String.class),
                method.load(configParam),
                method.load((String) param));
      } else {
      ...
      if (configParam != null) {
        out =
            method.invokeStaticMethod(
                ofMethod(ConfigHelper.class, "getInteger", Integer.class, String.class, int.class),
                method.load(configParam),
      ...
      if (configParam != null) {
        out =
            method.invokeStaticMethod(
                ofMethod(
                    ConfigHelper.class, "getBoolean", Boolean.class, String.class, boolean.class),
                method.load(configParam),
                method.load((Boolean) param));
      } else {
        out =
            method.invokeStaticMethod(
                ofMethod(Boolean.class, "valueOf", Boolean.class, boolean.class),
                method.load((Boolean) param));
      }
      ...
      try (TryBlock et = method.tryBlock()) {
        et.assign(
            value,
            et.newInstance(MethodDescriptor.ofConstructor(URL.class, String.class), et.load(url)));
        out = value;
        try (CatchBlockCreator malformed = et.addCatch(MalformedURLException.class)) {
          malformed.throwException(
              RuntimeException.class, "Malformed URL", malformed.getCaughtException());
        }
      }
      ...
      out =
          method.invokeStaticMethod(
              ofMethod(e.getDeclaringClass(), "valueOf", e.getDeclaringClass(), String.class), nm);
    } else if (param instanceof ReturnedProxy) {

      ReturnedProxy rp = (ReturnedProxy) param;
      if (!rp.__static$$init() && staticInit) {
        throw new RuntimeException(
            "Invalid proxy passed to template. "
                + rp
      ...
      ResultHandle currentThread =
          method.invokeStaticMethod(ofMethod(Thread.class, "currentThread", Thread.class));
      ResultHandle tccl =
          method.invokeVirtualMethod(
              ofMethod(Thread.class, "getContextClassLoader", ClassLoader.class), currentThread);
      out =
          method.invokeStaticMethod(
              ofMethod(
                  Class.class,
      ...
      out =
          method.invokeStaticMethod(
              ofMethod(Short.class, "valueOf", Short.class, short.class),
      ...
      out =
          method.invokeStaticMethod(
              ofMethod(Byte.class, "valueOf", Byte.class, byte.class), method.load((byte) param));
    } else if (expectedType == char.class) {
      out = method.load((char) param);
    } else if (expectedType == Character.class || param instanceof Character) {
      out =
          method.invokeStaticMethod(
              ofMethod(Character.class, "valueOf", Character.class, char.class),
      ...
      out =
          method.invokeStaticMethod(
              ofMethod(Long.class, "valueOf", Long.class, long.class), method.load((long) param));
    } else if (expectedType == float.class) {
      out = method.load((float) param);
    } else if (expectedType == Float.class || param instanceof Float) {
      out =
          method.invokeStaticMethod(
              ofMethod(Float.class, "valueOf", Float.class, float.class),
      ...
      out =
          method.invokeStaticMethod(
              ofMethod(Double.class, "valueOf", Double.class, double.class),
              method.load((double) param));
    } else if (expectedType.isArray()) {
      int length = Array.getLength(param);
      out = method.newArray(expectedType.getComponentType(), method.load(length));
      for (int i = 0; i < length; ++i) {
        ResultHandle component =
            loadObjectInstance(
                method, Array.get(param, i), returnValueResults, expectedType.getComponentType());
      ...
      if (nonDefaultConstructors.containsKey(param.getClass())) {
        ...
        for (Object i : params) {
          handles.add(
              loadObjectInstance(
                  method, i, returnValueResults, holder.constructor.getParameterTypes()[count++]));
        }
        out =
            method.newInstance(
                ofConstructor(
                    holder.constructor.getDeclaringClass(), holder.constructor.getParameterTypes()),
        ...
        try {
          ...
          throw new RuntimeException(
              "Unable to serialize objects of type "
                  + param.getClass()
      ...
      if (param instanceof Map) {
        for (Map.Entry<?, ?> i : ((Map<?, ?>) param).entrySet()) {
          ResultHandle key =
              loadObjectInstance(method, i.getKey(), returnValueResults, i.getKey().getClass());
          ResultHandle val =
              i.getValue() != null
                  ? loadObjectInstance(
                      method, i.getValue(), returnValueResults, i.getValue().getClass())
                  : null;
      ...
      for (PropertyDescriptor i : desc) {
        if (i.getReadMethod() != null && i.getWriteMethod() == null) {
          try {
            ...
            if (Collection.class.isAssignableFrom(i.getPropertyType())) {
              ...
              if (!propertyValue.isEmpty()) {
                ResultHandle prop =
                    method.invokeVirtualMethod(MethodDescriptor.ofMethod(i.getReadMethod()), out);
                for (Object c : propertyValue) {
                  ResultHandle toAdd =
                      loadObjectInstance(method, c, returnValueResults, Object.class);
              ...
              Map<Object, Object> propertyValue =
                  (Map<Object, Object>) PropertyUtils.getProperty(param, i.getName());
              if (!propertyValue.isEmpty()) {
                ResultHandle prop =
                    method.invokeVirtualMethod(MethodDescriptor.ofMethod(i.getReadMethod()), out);
                for (Map.Entry<Object, Object> entry : propertyValue.entrySet()) {
                  ResultHandle key =
                      loadObjectInstance(method, entry.getKey(), returnValueResults, Object.class);
                  ResultHandle val =
                      entry.getValue() != null
                          ? loadObjectInstance(
                              method, entry.getValue(), returnValueResults, Object.class)
                          : method.loadNull();
          ...
          try {
            ...
            ResultHandle val =
                loadObjectInstance(method, propertyValue, returnValueResults, i.getPropertyType());
            method.invokeVirtualMethod(
                ofMethod(param.getClass(), i.getWriteMethod().getName(), void.class, propertyType),
                out,
                val);
          } catch (Exception e) {
            throw new RuntimeException(e);
      ...
      for (Field field : param.getClass().getFields()) {
        if (!Modifier.isFinal(field.getModifiers())
          ...
          try {
            ResultHandle val =
                loadObjectInstance(method, field.get(param), returnValueResults, field.getType());
            method.writeInstanceField(
                FieldDescriptor.of(param.getClass(), field.getName(), field.getType()), out, val);
          } catch (Exception e) {
            throw new RuntimeException(e);
          }
        }
  ...
  static final class NonDefaultConstructorHolder {
    ...
    NonDefaultConstructorHolder(
        Constructor<?> constructor, Function<Object, List<Object>> paramGenerator) {
