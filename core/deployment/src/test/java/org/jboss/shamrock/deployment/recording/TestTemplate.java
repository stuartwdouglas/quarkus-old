...
public class TestTemplate {
  ...
  public void primitiveParams(
      boolean bool, byte b, char c, short s, int i, long l, float f, double d) {
    RESULT.add(bool);
    RESULT.add(b);
    RESULT.add(c);
    RESULT.add(s);
  ...
  public void boxedPrimitiveParams(
      Boolean bool, Byte b, Character c, Short s, Integer i, Long l, Float f, Double d) {
    RESULT.add(bool);
    RESULT.add(b);
    RESULT.add(c);
    RESULT.add(s);
