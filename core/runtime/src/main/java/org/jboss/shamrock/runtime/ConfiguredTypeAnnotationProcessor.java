...
/**
 * Annotation processor that saves the javadoc for @ConfiguredType classes so it can be accessed by
 * the build annotation processor in later modules
 */
              ...
              if (docComment == null) {
                processingEnv
                    ...
                    .printMessage(
                        ...
                        "Unable to find javadoc for config property " + field);
