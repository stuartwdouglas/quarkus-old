 ...
 *
 * <p>It is modified on substrate by {@link org.jboss.shamrock.runtime.graal.TimingReplacement}, in
 * that mainStarted it rewritten to actually update the start time.
 */
public class Timing {
  ...
  public static void printStartupTime(String version, String features, String httpServer) {
    ...
    final BigDecimal secondsRepresentation =
        BigDecimal.valueOf(bootTimeNanoSeconds) // As nanoseconds
            .divide(
                BigDecimal.valueOf(1_000_000),
                BigDecimal.ROUND_HALF_UP) // Convert to milliseconds, discard remaining digits while
            // rounding
            .divide(
                BigDecimal.valueOf(1_000),
                3,
                BigDecimal.ROUND_HALF_UP); // Convert to seconds, while preserving 3 digits
