...
/**
 * class that avoids the use of reflection in Shamrock when actually running on Graal.
 *
 * <p>Graal does not seem to like registering the program entry point as availble for reflection
 */
