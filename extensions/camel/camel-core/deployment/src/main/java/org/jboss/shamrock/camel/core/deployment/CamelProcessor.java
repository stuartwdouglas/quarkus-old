...
import org.jboss.shamrock.jaxb.JaxbFileRootBuildItem;
...
class CamelProcessor {
    ...
    protected void addCamelServices() {
        CamelSupport.resources(applicationArchivesBuildItem, CamelSupport.CAMEL_SERVICE_BASE_PATH).forEach(this::addCamelService);
    }
