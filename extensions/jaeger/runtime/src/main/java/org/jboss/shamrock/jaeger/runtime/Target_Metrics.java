...
public final class Target_Metrics {
  ...
  @Alias public Counter traceStartedSampled;

  @Alias public Counter traceStartedNotSampled;

  @Alias public Counter tracesJoinedSampled;

  @Alias public Counter tracesJoinedNotSampled;

  @Alias public Counter spansStartedSampled;

  @Alias public Counter spansStartedNotSampled;

  @Alias public Counter spansFinished;

  @Alias public Counter decodingErrors;

  @Alias public Counter reporterSuccess;

  @Alias public Counter reporterFailure;

  @Alias public Counter reporterDropped;

  @Alias public Gauge reporterQueueLength;

  @Alias public Counter samplerRetrieved;

  @Alias public Counter samplerQueryFailure;

  @Alias public Counter samplerUpdated;

  @Alias public Counter samplerParsingFailure;

  @Alias public Counter baggageUpdateSuccess;

  @Alias public Counter baggageUpdateFailure;

  @Alias public Counter baggageTruncate;

  @Alias public Counter baggageRestrictionsUpdateSuccess;

  @Alias public Counter baggageRestrictionsUpdateFailure;
  ...
  private void createMetrics(MetricsFactory factory, String metricsPrefix) {
    ...
    decodingErrors =
        factory.createCounter(
            metricsPrefix + "span_context_decoding_errors", Collections.emptyMap());
    ...
    reporterQueueLength =
        factory.createGauge(metricsPrefix + "reporter_queue_length", Collections.emptyMap());
    ...
    baggageTruncate =
        factory.createCounter(metricsPrefix + "baggage_truncations", Collections.emptyMap());

    tags = new HashMap<String, String>();
    tags.put("result", "ok");
    baggageRestrictionsUpdateSuccess =
        factory.createCounter(metricsPrefix + "baggage_restrictions_updates", tags);
