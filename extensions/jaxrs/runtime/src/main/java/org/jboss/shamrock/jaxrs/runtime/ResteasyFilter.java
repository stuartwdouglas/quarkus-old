...
/**
 * A filter that will be mapped to the default servlet. At first content will attempt to be served
 * from the default servlet, and if it fails then a REST response will be attempted
 */
