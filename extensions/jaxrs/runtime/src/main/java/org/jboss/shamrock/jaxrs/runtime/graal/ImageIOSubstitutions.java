...
final class ImageIOSubstitutions {
  ...
  /**
   * Returns an array of {@code String}s listing all of the MIME types understood by the current set
   * of registered writers.
   *
  ...
  /**
   * Returns an array of {@code String}s listing all of the file suffixes associated with the
   * formats understood by the current set of registered writers.
   *
   * @return an array of {@code String}s.
   * @since 1.6
   */
