...
@TargetClass(
    className = "com.sun.xml.internal.bind.v2.model.annotation.LocatableAnnotation",
    onlyWith = InternalLocatableAnnotationSubstitutions.Selector.class)
final class InternalLocatableAnnotationSubstitutions {
  ...
  @TargetClass(
      className = "com.sun.xml.internal.bind.v2.model.annotation.Locatable",
      onlyWith = InternalLocatableAnnotationSubstitutions.Selector.class)
