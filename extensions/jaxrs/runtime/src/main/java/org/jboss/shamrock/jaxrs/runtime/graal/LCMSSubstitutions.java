...
final class LCMSSubstitutions {
  ...
  /**
   * Writes supplied data as a tag into the profile. Destroys old profile, if new one was
   * successfully created.
   *
   * <p>Returns valid pointer to new profile.
   *
   * <p>Throws CMMException if operation fails, preserve old profile from destruction.
   */
  @Substitute
  ...
  private static long createNativeTransform(
      ...
      int renderType,
      int inFormatter,
      boolean isInIntPacked,
      int outFormatter,
      boolean isOutIntPacked,
      Object disposerRef) {
    throw new RuntimeException("Not Implemented");
  }
