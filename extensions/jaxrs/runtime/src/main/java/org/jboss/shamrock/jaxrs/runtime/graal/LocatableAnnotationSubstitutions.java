...
@TargetClass(
    className = "com.sun.xml.bind.v2.model.annotation.LocatableAnnotation",
    onlyWith = LocatableAnnotationSubstitutions.Selector.class)
final class LocatableAnnotationSubstitutions {
  ...
  @TargetClass(
      className = "com.sun.xml.bind.v2.model.annotation.Locatable",
      onlyWith = LocatableAnnotationSubstitutions.Selector.class)
