...
public final class CompareMode {
  ...
  @Alias private static volatile CompareMode lastUsed;

  //    @Inject
  //    private static final org.h2.value.CompareMode SINGLE_CHOICE =
  // org.h2.value.CompareMode.getInstance(null, 0, SysProperties.SORT_BINARY_UNSIGNED);
