...
public final class DefaultAuthenticationProvider_Substitutions {
  ...
  @Substitute
  public static InterfaceAuthSwitchSendResponsePacket processAuthPlugin(
    ...
    switch (plugin) {
      case MYSQL_NATIVE_PASSWORD:
        return new SendNativePasswordAuthPacket(
            password, authData, seqNo, passwordCharacterEncoding);
      case MYSQL_OLD_PASSWORD:
        return new SendOldPasswordAuthPacket(password, authData, seqNo, passwordCharacterEncoding);
      case MYSQL_CLEAR_PASSWORD:
        return new SendClearPasswordAuthPacket(
            password, authData, seqNo, passwordCharacterEncoding);
      case DIALOG:
      ...
      case GSSAPI_CLIENT:
        return new SendGssApiAuthPacket(
            reader, password, authData, seqNo, passwordCharacterEncoding);
      case MYSQL_ED25519_PASSWORD:
        return new SendEd25519PasswordAuthPacket(
            password, authData, seqNo, passwordCharacterEncoding);
