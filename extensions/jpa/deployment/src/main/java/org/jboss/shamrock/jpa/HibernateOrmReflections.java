...
/**
 * This list of classes which any Hibernate ORM using application should register for reflective
 * access on SubstrateVM.
 *
 * <p>FIXME Find a reliable way to identify these and maintain the list accurate: the current list
...
public final class HibernateOrmReflections {
  ...
  public void registerCoreReflections(BuildProducer<ReflectiveClassBuildItem> reflectiveClass) {
    ...
    allConstructors(
        reflectiveClass, org.hibernate.persister.collection.BasicCollectionPersister.class);
    simpleConstructor(
    ...
    reflectiveClass.produce(
        new ReflectiveClassBuildItem(
            true, false, com.arjuna.ats.jta.UserTransaction.class.getName()));
    reflectiveClass.produce(
        new ReflectiveClassBuildItem(
            true, false, com.arjuna.ats.jta.TransactionManager.class.getName()));
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.EntityJoinFromElement.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.UnaryLogicOperatorNode.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.AbstractRestrictableStatement.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.UpdateStatement.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.SelectExpressionImpl.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.CastFunctionNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.MapKeyEntityFromElement.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.SelectExpressionList.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.ImpliedFromElement.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.IsNotNullLogicOperatorNode.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.InsertStatement.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.UnaryArithmeticNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.CollectionFunction.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.BinaryLogicOperatorNode.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.CountNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.IsNullLogicOperatorNode.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.AbstractSelectExpression.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.InLogicOperatorNode.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.IndexNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.AbstractNullnessCheckNode.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.DotNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.ResultVariableRefNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.BetweenOperatorNode.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.BooleanLiteralNode.class);
    simpleConstructor(reflectiveClass, org.hibernate.hql.internal.ast.tree.SimpleCaseNode.class);
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.AbstractMapComponentNode.class);
    ...
    simpleConstructor(
        reflectiveClass, org.hibernate.hql.internal.ast.tree.BinaryArithmeticOperatorNode.class);
  }

  private void allConstructors(
      BuildProducer<ReflectiveClassBuildItem> reflectiveClass, final Class<?> clazz) {
  ...
  private void simpleConstructor(
      BuildProducer<ReflectiveClassBuildItem> reflectiveClass, final Class<?> clazz) {
    simpleConstructor(reflectiveClass, clazz.getName());
  }

  private void simpleConstructor(
      BuildProducer<ReflectiveClassBuildItem> reflectiveClass, final String clazzName) {
