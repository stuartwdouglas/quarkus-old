...
final class FastBootHibernatePersistenceProviderResolver implements PersistenceProviderResolver {
  ...
  private static final List<PersistenceProvider> HARDCODED_PROVIDER_LIST =
      Collections.<PersistenceProvider>singletonList(new FastBootHibernatePersistenceProvider());
