...
package org.jboss.shamrock.jpa.runtime.boot.scan;
...
/**
 * A hard coded scanner. This scanner is serialized to bytecode, and used to avoid scanning on
 * Hibernate startup. Technically the scanners are receiving all classes and categorize them as JPA
 * useful or not. In Shamrock's case, we detect the JPA friendly ones and not list the other ones.
...
public class ShamrockScanner implements Scanner {
  ...
  public ScanResult scan(
      ScanEnvironment scanEnvironment, ScanOptions scanOptions, ScanParameters scanParameters) {
    return new Result();
  }
