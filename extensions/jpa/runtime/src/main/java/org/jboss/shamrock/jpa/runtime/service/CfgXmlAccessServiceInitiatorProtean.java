...
public final class CfgXmlAccessServiceInitiatorProtean
    implements StandardServiceInitiator<CfgXmlAccessService> {

  public static final CfgXmlAccessServiceInitiatorProtean INSTANCE =
      new CfgXmlAccessServiceInitiatorProtean();

  @Override
  public CfgXmlAccessService initiateService(
