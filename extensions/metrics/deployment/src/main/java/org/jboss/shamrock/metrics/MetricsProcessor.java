...
public class MetricsProcessor {
  ...
  ServletBuildItem createServlet() {
    ServletBuildItem servletBuildItem =
        new ServletBuildItem("metrics", MetricsServlet.class.getName());
  ...
  public void build(
    ...
    reflectiveClasses.produce(
        new ReflectiveClassBuildItem(false, false, MetricsBinding.class.getName()));

    metrics.createRegistries(beanContainerBuildItem.getValue());

    IndexView index = beanArchiveIndex.getIndex();
    Collection<AnnotationInstance> annos =
        index.getAnnotations(DotName.createSimple(Counted.class.getName()));
    ...
    for (AnnotationInstance anno : annos) {
      ...
      metrics.registerCounted(classInfo.name().toString(), name);
    }
  }
