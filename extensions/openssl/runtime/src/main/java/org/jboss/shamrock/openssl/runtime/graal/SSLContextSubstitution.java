...
public final class SSLContextSubstitution {
  ...
  public static SSLContext getInstance(String protocol) throws NoSuchAlgorithmException {
    return (SSLContext)
        (Object)
            new SSLContextSubstitution(Utils.getSpi(protocol), OpenSSLProvider.INSTANCE, protocol);
  }
  ...
  public static SSLContext getInstance(String protocol, Provider provider)
    ...
    if (provider instanceof OpenSSLProvider) {
      return (SSLContext)
          (Object) new SSLContextSubstitution(Utils.getSpi(protocol), provider, protocol);
    } else {
