...
public class OpentracingProcessor {
  ...
  List<AdditionalBeanBuildItem> registerBeans() {
    return Arrays.asList(
        new AdditionalBeanBuildItem(OpenTracingInterceptor.class, TracerProducer.class));
  }
  ...
  @BuildStep
  void setupFilter(
      BuildProducer<JaxrsProviderBuildItem> providers,
    ...
    FilterBuildItem filterInfo =
        new FilterBuildItem("tracingFilter", SpanFinishingFilter.class.getName());
