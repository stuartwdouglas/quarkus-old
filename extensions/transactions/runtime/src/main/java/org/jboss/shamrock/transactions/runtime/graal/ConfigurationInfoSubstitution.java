...
final class ConfigurationInfoSubstitution {
  ...
  @Alias private static String sourceId;
  @Alias private static String propertiesFile;
  @Alias private static String buildId;
  @Alias private static boolean isInitialized = false;
