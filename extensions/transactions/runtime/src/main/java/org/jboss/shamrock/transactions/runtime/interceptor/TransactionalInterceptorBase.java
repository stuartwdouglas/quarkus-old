...
public abstract class TransactionalInterceptorBase implements Serializable {
  ...
  public Object intercept(InvocationContext ic) throws Exception {
    ...
    boolean previousUserTransactionAvailability =
        setUserTransactionAvailable(userTransactionAvailable);
    try {
   ...
   *
   * <p>Method handles CDI types to cover cases where extensions are used. In case of EE container
   * uses reflection.
   *
  ...
  protected void handleException(InvocationContext ic, Exception e, Transaction tx)
      throws Exception {
