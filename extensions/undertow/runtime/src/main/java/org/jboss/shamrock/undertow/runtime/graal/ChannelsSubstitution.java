...
public final class ChannelsSubstitution {
  ...
  @Delete() private static ByteBuffer DRAIN_BUFFER = null;
   ...
   * @return the number of bytes drained, 0 if reading the channel would block, or -1 if the EOF was
   *     reached
  ...
  /**
   * Attempt to drain the given number of bytes from the file channel. This does nothing more than
   * force a read of bytes in the file.
   *
   * @param channel the channel to drain
