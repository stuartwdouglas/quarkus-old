...
final class Target_sun_misc_URLClassPath {
  ...
  @Alias private AccessControlContext acc;
            ...
            public Target_sun_misc_URLClassPath$Loader run() throws IOException {
              ...
              if (file != null && file.endsWith("/")) {
                if ("file".equals(url.getProtocol())) {
                  return (Target_sun_misc_URLClassPath$Loader)
                      (Object) new Target_sun_misc_URLClassPath$FileLoader(url);
                } else {
...
final class Target_sun_nio_ch_DatagramChannelImpl {
  ...
  @Substitute
  private static void disconnect0(FileDescriptor fd, boolean isIPv6) throws IOException {
    throw new RuntimeException(
        "Unimplemented: sun.nio.ch.DatagramChannelImpl.disconnect0(FileDescriptor, boolean)");
  }
}
