...
final class Target_io_netty_handler_ssl_SslHandler$SslEngineType {
  ...
  @Alias public static Target_io_netty_handler_ssl_SslHandler$SslEngineType JDK;

  @Alias public static Target_io_netty_handler_ssl_SslHandler$SslEngineType CONSCRYPT;

  @Substitute
  static Target_io_netty_handler_ssl_SslHandler$SslEngineType forEngine(SSLEngine engine) {
    return (Object) engine instanceof Target_io_netty_handler_ssl_ConscryptAlpnSslEngine
        ? CONSCRYPT
        : JDK;
  }
}
...
final class Target_io_netty_handler_ssl_SslContext {
  ...
  static SslContext newServerContextInternal(
    ...
    return (SslContext)
        (Object)
            new Target_io_netty_handler_ssl_JdkSslServerContext(
                sslContextProvider,
                trustCertCollection,
                trustManagerFactory,
                keyCertChain,
  ...
  static SslContext newClientContextInternal(
    ...
    return (SslContext)
        (Object)
            new Target_io_netty_handler_ssl_JdkSslClientContext(
                sslContextProvider,
                trustCert,
                trustManagerFactory,
                keyCertChain,
...
final class Target_io_netty_handler_ssl_JdkDefaultApplicationProtocolNegotiator {
  ...
  @Alias public static Target_io_netty_handler_ssl_JdkDefaultApplicationProtocolNegotiator INSTANCE;
}
...
final class Target_io_netty_handler_ssl_JdkSslContext {
  ...
  @Substitute
  static JdkApplicationProtocolNegotiator toNegotiator(
...
final class Target_io_netty_bootstrap_AbstractBootstrap {
  ...
  @Alias private ChannelFactory channelFactory;
