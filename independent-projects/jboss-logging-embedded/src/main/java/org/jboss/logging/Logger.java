...
public abstract class Logger implements Serializable, BasicLogger {
  ...
  protected abstract void doLog(
      Level level, String loggerClassName, Object message, Object[] parameters, Throwable thrown);
  ...
  protected abstract void doLogf(
      Level level, String loggerClassName, String format, Object[] parameters, Throwable thrown);

  /**
   * Check to see if the {@code TRACE} level is enabled for this logger.
   *
   * @return {@code true} if messages logged at {@link Level#TRACE} may be accepted, {@code false}
   *     otherwise
   */
   ...
   * @deprecated To log a message with parameters, using {@link #tracev(String, Object...)} is
   *     recommended.
   */
  @Deprecated
  @AlwaysInline("Fast level checks")
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #tracev(Throwable, String,
  ...
  @AlwaysInline("Fast level checks")
  public void tracef(
      final Throwable t, final String format, final int arg1, final int arg2, final int arg3) {
    if (isEnabled(Level.TRACE)) {
  ...
  @AlwaysInline("Fast level checks")
  public void tracef(
      final Throwable t, final String format, final int arg1, final int arg2, final Object arg3) {
    if (isEnabled(Level.TRACE)) {
      doLogf(Level.TRACE, FQCN, format, new Object[] {arg1, arg2, arg3}, t);
    }
  }
  ...
  @AlwaysInline("Fast level checks")
  public void tracef(
      final Throwable t, final String format, final long arg1, final long arg2, final long arg3) {
    if (isEnabled(Level.TRACE)) {
      doLogf(Level.TRACE, FQCN, format, new Object[] {arg1, arg2, arg3}, t);
    }
  }
  ...
  @AlwaysInline("Fast level checks")
  public void tracef(
      final Throwable t, final String format, final long arg1, final long arg2, final Object arg3) {
    if (isEnabled(Level.TRACE)) {
      doLogf(Level.TRACE, FQCN, format, new Object[] {arg1, arg2, arg3}, t);
    }
  }
   ...
   *
   * @return {@code true} if messages logged at {@link Level#DEBUG} may be accepted, {@code false}
   *     otherwise
   */
  @AlwaysInline("Fast level checks")
   ...
   * @param message the message
   * @param params the message parameters
   * @deprecated To log a message with parameters, using {@link #debugv(String, Object...)} is
   *     recommended.
   */
  @Deprecated
  @AlwaysInline("Fast level checks")
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #debugv(Throwable, String,
   *     Object...)} is recommended.
   */
  @Deprecated
  @AlwaysInline("Fast level checks")
   ...
   *
   * @return {@code true} if messages logged at {@link Level#INFO} may be accepted, {@code false}
   *     otherwise
   */
  @AlwaysInline("Fast level checks")
   ...
   * @param message the message
   * @param params the message parameters
   * @deprecated To log a message with parameters, using {@link #infov(String, Object...)} is
   *     recommended.
   */
  @Deprecated
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #infov(Throwable, String,
   *     Object...)} is recommended.
   */
  @Deprecated
   ...
   * @param message the message
   * @param params the message parameters
   * @deprecated To log a message with parameters, using {@link #warnv(String, Object...)} is
   *     recommended.
   */
  @Deprecated
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #warnv(Throwable, String,
   *     Object...)} is recommended.
   */
  @Deprecated
   ...
   * @param message the message
   * @param params the message parameters
   * @deprecated To log a message with parameters, using {@link #errorv(String, Object...)} is
   *     recommended.
   */
  @Deprecated
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #errorv(Throwable, String,
   *     Object...)} is recommended.
   */
  @Deprecated
   ...
   * @param message the message
   * @param params the message parameters
   * @deprecated To log a message with parameters, using {@link #fatalv(String, Object...)} is
   *     recommended.
   */
  @Deprecated
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #fatalv(Throwable, String,
   *     Object...)} is recommended.
   */
  @Deprecated
   ...
   * @param message the message
   * @param params the message parameters
   * @deprecated To log a message with parameters, using {@link #logv(Level, String, Object...)} is
   *     recommended.
   */
  @Deprecated
  @AlwaysInline("Fast level checks")
   ...
   * @param params the message parameters
   * @param t the throwable
   * @deprecated To log a message with parameters, using {@link #logv(Level, Throwable, String,
   *     Object...)} is recommended.
   */
  @Deprecated
  @AlwaysInline("Fast level checks")
  ...
  @AlwaysInline("Fast level checks")
  public void logv(
      Level level, Throwable t, String format, Object param1, Object param2, Object param3) {
    if (isEnabled(level)) {
  ...
  @AlwaysInline("Fast level checks")
  public void logv(
      String loggerFqcn, Level level, Throwable t, String format, Object param1, Object param2) {
    if (isEnabled(level)) {
  ...
  /**
   * Get a typed logger which implements the given interface. The current default locale will be
   * used for the new logger.
   *
  ...
  /**
   * Get a typed logger which implements the given interface. The given locale will be used for the
   * new logger.
   *
   * @param type the interface to implement
   * @param category the logger category
   ...
   * @return the typed logger
   */
  public static <T> T getMessageLogger(
      final Class<T> type, final String category, final Locale locale) {
    return doPrivileged(
          ...
          public T run() {
            ...
            if (variant != null && variant.length() > 0)
              try {
                loggerClass =
                    Class.forName(
                            join(typeName, "$logger", language, country, variant),
                            true,
                            classLoader)
                        .asSubclass(type);
            ...
            if (loggerClass == null && country != null && country.length() > 0)
              try {
                loggerClass =
                    Class.forName(
                            join(typeName, "$logger", language, country, null), true, classLoader)
                        .asSubclass(type);
              } catch (ClassNotFoundException e) {
                // ignore
              }
            if (loggerClass == null && language != null && language.length() > 0)
              try {
                loggerClass =
                    Class.forName(
                            join(typeName, "$logger", language, null, null), true, classLoader)
                        .asSubclass(type);
              } catch (ClassNotFoundException e) {
                // ignore
              }
            ...
            try {
              ...
              throw new IllegalArgumentException(
                  "Logger implementation " + loggerClass + " could not be instantiated",
                  e.getCause());
            }
          }
        });
