...
public interface LoggerProvider {
   ...
   *
   * <p><b>Note:</b> this should never be {@code null}
   *
  ...
  /**
   * Returns the value for the key on the message diagnostics context or {@code null} if no value
   * was found.
   *
   ...
   *
   * <p>Note that in most implementations this is an expensive operation and should be used
   * sparingly.
   *
   * @return the map from the context or an {@linkplain Collections#emptyMap() empty map} if the
