...
final class CopyOnWriteMap<K, V> extends AbstractMap<K, V>
  ...
  private static final AtomicReferenceFieldUpdater<CopyOnWriteMap, FastCopyHashMap> mapUpdater =
      AtomicReferenceFieldUpdater.newUpdater(CopyOnWriteMap.class, FastCopyHashMap.class, "map");
