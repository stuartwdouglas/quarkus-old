...
public final class LogContext {
  ...
  /**
   * Get a logger with the given name from this logging context, if a logger node exists at that
   * location.
   *
   * @param name the logger name
  ...
  static EmbeddedConfigurator getConfigurator() {
    final ServiceLoader<EmbeddedConfigurator> configLoader =
        ServiceLoader.load(EmbeddedConfigurator.class, LogContext.class.getClassLoader());
  ...
  /**
   * Returns an enumeration of the logger names that have been created. This does not return names
   * of loggers that may have been garbage collected. Logger names added after the enumeration has
   * been retrieved may also be added to the enumeration.
   *
