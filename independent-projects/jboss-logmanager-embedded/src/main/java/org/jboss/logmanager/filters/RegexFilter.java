...
/**
 * A regular-expression-based filter. Used to exclude log records which match or don't match the
 * expression. The regular expression is checked against the raw (unformatted) message.
 */
