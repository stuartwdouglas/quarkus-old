...
public final class Formatters {
  ...
  private static final Formatter NULL_FORMATTER =
      new Formatter() {
  ...
  /**
   * Apply up to {@code precision} trailing segments of the given string to the given {@code
   * builder}. If the precision contains non-integer values
   *
  ...
  private abstract static class JustifyingFormatStep implements FormatStep {
    ...
    protected JustifyingFormatStep(
    ...
    public abstract void renderRaw(
        Formatter formatter, final StringBuilder builder, final ExtLogRecord record);
  }
   ...
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   *     or 0 for none
   * @param precision the argument used for the logger name, may be {@code null} or contain dots to
   *     format the logger name
   * @return the format
   */
  public static FormatStep loggerNameFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final int maximumWidth,
      final String precision) {
    return loggerNameFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth, precision);
  }
   ...
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   * @param truncateBeginning {@code true} to truncate the beginning, otherwise {@code false} to
   *     truncate the end
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   *     or 0 for none
   * @param precision the argument used for the logger name, may be {@code null} or contain dots to
  ...
  public static FormatStep loggerNameFormatStep(
      ...
      final int maximumWidth,
      final String precision) {
    return new SegmentedFormatStep(
        leftJustify, minimumWidth, truncateBeginning, maximumWidth, precision) {
      public ItemType getItemType() {
  ...
  /**
   * Create a format step which emits the source class name with the given justification rules
   ...
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   *     or 0 for none
   * @param precision the argument used for the class name, may be {@code null} or contain dots to
   *     format the class name
   * @return the format step
   */
  public static FormatStep classNameFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final int maximumWidth,
      final String precision) {
    return classNameFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth, precision);
  }
  ...
  /**
   * Create a format step which emits the source module name with the given justification rules
   * (NOTE: call stack introspection introduces a significant performance penalty).
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep moduleNameFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final int maximumWidth,
      final String precision) {
    return moduleNameFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth, precision);
  }
  ...
  /**
   * Create a format step which emits the source module version with the given justification rules
   * (NOTE: call stack introspection introduces a significant performance penalty).
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep moduleVersionFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final int maximumWidth,
      final String precision) {
   ...
   * @return the format step
   */
  public static FormatStep dateFormatStep(
      final TimeZone timeZone,
      final String formatString,
      final boolean leftJustify,
      final int minimumWidth,
      final int maximumWidth) {
    return dateFormatStep(
        timeZone,
        formatString,
        leftJustify,
        minimumWidth,
            ...
            protected SimpleDateFormat initialValue() {
              final SimpleDateFormat dateFormat =
                  new SimpleDateFormat(
                      formatString == null ? "yyyy-MM-dd HH:mm:ss,SSS" : formatString);
  ...
  public static FormatStep dateFormatStep(
      ...
      final int maximumWidth) {
    return dateFormatStep(
        TimeZone.getDefault(), formatString, leftJustify, minimumWidth, maximumWidth);
  }

  /**
   * Create a format step which emits the source file name with the given justification rules (NOTE:
   * call stack introspection introduces a significant performance penalty).
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   ...
   * @return the format step
   */
  public static FormatStep fileNameFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
   ...
   * @return the format step
   */
  public static FormatStep processNameFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final boolean truncateBeginning,
      final int maximumWidth) {
  ...
  /**
   * Create a format step which emits the source file line number with the given justification rules
   * (NOTE: call stack introspection introduces a significant performance penalty).
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep processIdFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final boolean truncateBeginning,
      final int maximumWidth) {
   ...
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   *     or 0 for none
   * @param qualified {@code true} to use the fully qualified host name, {@code false} to only use
   *     the
   * @return the format step
   */
  public static FormatStep hostnameFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final boolean truncateBeginning,
      final int maximumWidth,
    ...
    return new SegmentedFormatStep(
        leftJustify, minimumWidth, truncateBeginning, maximumWidth, null) {
      public ItemType getItemType() {
  ...
  /**
   * Create a format step which emits the complete source location information with the given
   * justification rules (NOTE: call stack introspection introduces a significant performance
   * penalty).
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep locationInformationFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return locationInformationFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
   ...
   * @return the format step
   */
  public static FormatStep lineNumberFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return lineNumberFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
  ...
  /**
   * Create a format step which emits the formatted log message text with the given justification
   * rules.
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep messageFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
  ...
  public static FormatStep messageFormatStep(
    ...
    return new JustifyingFormatStep(leftJustify, minimumWidth, truncateBeginning, maximumWidth) {
      public void renderRaw(
        ...
        String formatted;
        if (formatter == null
            || record.getFormatStyle() == ExtLogRecord.FormatStyle.PRINTF
                && !(formatter instanceof ExtFormatter)) {
  ...
  /**
   * Create a format step which emits the formatted log message text (simple version, no exception
   * traces) with the given justification rules.
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   ...
   * @return the format step
   */
  public static FormatStep simpleMessageFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return simpleMessageFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
  ...
  /**
   * Create a format step which emits the stack trace of an exception with the given justification
   * rules.
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   * @param maximumWidth the maximum field width (must be greater than {@code minimumFieldWidth}),
   *     or 0 for none
   * @param extended {@code true} if the stack trace should attempt to include extended JAR version
   *     information
   * @return the format step
   */
  public static FormatStep exceptionFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final int maximumWidth,
      final boolean extended) {
    return exceptionFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth, null);
  }
  ...
  /**
   * Create a format step which emits the log message resource key (if any) with the given
   * justification rules.
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep resourceKeyFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return resourceKeyFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
  ...
  /**
   * Create a format step which emits the source method name with the given justification rules
   * (NOTE: call stack introspection introduces a significant performance penalty).
   *
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   ...
   * @return the format step
   */
  public static FormatStep methodNameFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return methodNameFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
   ...
   * @return the format step
   */
  public static FormatStep lineSeparatorFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return lineSeparatorFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
   ...
   * @return the format step
   */
  public static FormatStep levelFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
   ...
   * @return the format step
   */
  public static FormatStep localizedLevelFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return localizedLevelFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
  ...
  public static FormatStep localizedLevelFormatStep(
    ...
    return new JustifyingFormatStep(leftJustify, minimumWidth, truncateBeginning, maximumWidth) {
      ...
      public void renderRaw(
        ...
        final Level level = record.getLevel();
        builder.append(
            level.getResourceBundleName() != null ? level.getLocalizedName() : level.getName());
      }
    };
  }
  ...
  public static FormatStep relativeTimeFormatStep(
      ...
      final int minimumWidth,
      final int maximumWidth) {
    return relativeTimeFormatStep(
        baseTime, leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
  ...
  /**
   * Create a format step which emits the id if {@code id} is passed as the argument, otherwise the
   * the thread name is used.
   *
   * @param argument the argument which may be {@code id} to indicate the thread id or {@code null}
   *     to indicate the thread name
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   * @param truncateBeginning {@code true} to truncate the beginning, otherwise {@code false} to
   *     truncate the end
   ...
   * @return the format step
   */
  public static FormatStep threadFormatStep(
      final String argument,
      final boolean leftJustify,
      final int minimumWidth,
      final boolean truncateBeginning,
   ...
   * @return the format step
   */
  public static FormatStep threadIdFormatStep(
      final boolean leftJustify,
      final int minimumWidth,
      final boolean truncateBeginning,
      final int maximumWidth) {
   ...
   * @return the format step
   */
  public static FormatStep threadNameFormatStep(
      final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
    return threadNameFormatStep(
        leftJustify, minimumWidth, DEFAULT_TRUNCATE_BEGINNING, maximumWidth);
  }
  ...
  public static FormatStep ndcFormatStep(
      ...
      final int count) {
    return new SegmentedFormatStep(
        leftJustify, minimumWidth, truncateBeginning, maximumWidth, count) {
      public ItemType getItemType() {
        return ItemType.NDC;
      }
   ...
   * @return the format step
   */
  public static FormatStep mdcFormatStep(
      final String key, final boolean leftJustify, final int minimumWidth, final int maximumWidth) {
   ...
   *
   * @param argument the argument that may be a key or key with a default value separated by a
   *     colon, cannot be {@code null}
   * @param leftJustify {@code true} to left justify, {@code false} to right justify
   * @param minimumWidth the minimum field width, or 0 for none
   * @param truncateBeginning {@code true} to truncate the beginning, otherwise {@code false} to
   *     truncate the end
   ...
   */
  public static FormatStep systemPropertyFormatStep(
      final String argument,
      final boolean leftJustify,
      final int minimumWidth,
      final boolean truncateBeginning,
