 ...
 *
 * <ul>
 *   <li>{@link org.jboss.logmanager.ExtLogRecord#getSourceClassName() source class name}
 *   <li>{@link org.jboss.logmanager.ExtLogRecord#getSourceFileName() source file name}
 *   <li>{@link org.jboss.logmanager.ExtLogRecord#getSourceMethodName() source method name}
 *   <li>{@link org.jboss.logmanager.ExtLogRecord#getSourceLineNumber() source line number}
 * </ul>
 *
...
public class XmlFormatter extends StructuredFormatter {
   ...
   * Creates a new XML formatter.
   *
   * <p>If the {@code keyOverrides} is empty the default {@linkplain #DEFAULT_NAMESPACE namespace}
   * will be used.
   *
  ...
  /**
   * Indicates whether or not the name space should be written on the <code>{@literal <record/>}
   * </code>.
   *
  ...
  /**
   * Turns on or off the printing of the namespace for each <code>{@literal <record/>}</code>. This
   ...
   *
   * @param namespaceUri the namespace to use or {@code null} if no namespace URI should be used
   *     regardless of the {@link #isPrintNamespace()} value
   */
