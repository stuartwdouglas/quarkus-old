...
/**
 * An output stream handler which supports any {@code OutputStream}, using the specified encoding.
 * If no encoding is specified, the platform default is used.
 */
public class OutputStreamHandler extends WriterHandler {
  ...
  /**
   * Set the output stream to write to. The output stream will then belong to this handler; when the
   * handler is closed or a new writer or output stream is set, this output stream will be closed.
   *
