...
public class SslTcpOutputStream extends TcpOutputStream implements FlushableCloseable {
   ...
   *
   * <p>Uses the {@link javax.net.ssl.SSLSocketFactory#getDefault() default socket factory} to
   * create the socket.
   *
   ...
   */
  public SslTcpOutputStream(
      final InetAddress address, final int port, final boolean blockOnReconnect)
      throws IOException {
