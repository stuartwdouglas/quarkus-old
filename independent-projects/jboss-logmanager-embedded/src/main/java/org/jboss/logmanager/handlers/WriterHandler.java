...
public class WriterHandler extends ExtHandler {
  ...
  /**
   * Execute any pre-write policy, such as file rotation. The write lock is held during this method,
   * so make it quick. The default implementation does nothing.
   *
  ...
  /**
   * Set the writer. The writer will then belong to this handler; when the handler is closed or a
   * new writer is set, this writer will be closed.
   *
