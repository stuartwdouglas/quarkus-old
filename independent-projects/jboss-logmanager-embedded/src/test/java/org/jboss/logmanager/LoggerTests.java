...
public final class LoggerTests {
  ...
  public void testInstall() {
    assertTrue(
        "Wrong logger class", (java.util.logging.Logger.getLogger("test") instanceof Logger));
  }
  ...
  public void testCategories() {
    ...
    assertNotNull(
        "Logger not created with category: Spaced Logger Name",
        Logger.getLogger("Spaced Logger Name"));
    assertNotNull(
        "Logger not created with category: /../Weird/Path", Logger.getLogger("/../Weird/Path"));
    assertNotNull(
