...
public class NativeImageMojo extends AbstractMojo {
  ...
  @Parameter private boolean enableHttpUrlHandler;

  @Parameter private boolean enableHttpsUrlHandler;

  @Parameter private boolean enableAllSecurityServices;

  @Parameter private boolean enableRetainedHeapReporting;

  @Parameter private boolean enableIsolates;

  @Parameter private boolean enableCodeSizeReporting;
  ...
  @Parameter private List<String> additionalBuildArgs;
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    try {
      new AppCreator()
          ...
          .setArtifactResolver(
              new ResolvedMavenArtifactDeps(
                  project.getGroupId(),
                  project.getArtifactId(),
                  project.getVersion(),
                  project.getArtifacts()))

          // this mojo runs on the assumption that the outcomes of the augmentation and runner jar
          // building phases
          // are already available
          .pushOutcome(
              AugmentOutcome.class,
              new AugmentOutcome() {
          ...
          .create(
              new AppArtifact(project.getGroupId(), project.getArtifactId(), project.getVersion()));
