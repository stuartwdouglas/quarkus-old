...
public class MojoUtils {
  ...
  /**
   * Checks whether or not the given project has a plugin with the given key. The key is given using
   * the "groupId:artifactId" syntax.
   *
  ...
  private static void loadProperties() {
    ...
    try (InputStream in = url.openStream()) {
      ...
      throw new IllegalStateException(
          "Invalid packaging of the shamrock-maven-plugin, the shamrock-maven-plugin"
