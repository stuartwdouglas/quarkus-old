 ...
 * process is stop when {@link RunningInvoker#stop()} is called.
 */
public class RunningInvoker extends MavenProcessInvoker {
  ...
  public void stop() {
        ...
        JProcesses.getProcessList()
            ...
            .filter(
                pi ->
                    ...
                    pi.getCommand().contains("shamrock:dev")
    ...
    list.stream()
        ...
        .forEach(i -> JProcesses.killProcessGracefully(Integer.valueOf(i.getPid())));
  }
